//
// Created by HarryLex on 8/11/2022.
//

#ifndef K_MEANS_V1_KMEANSCODE_H
#define K_MEANS_V1_KMEANSCODE_H
...
//DBL_MAX is the maximum value for a variable of type double.
...
void get_data(vector<DataPoint> &dataset, bool random_gen = true) {
    if (random_gen) {
        string op; cout << "Shape (random or bubbles): "; cin >> op;
        if (op == "random") {
            srand(time(NULL));
        ...
        string path(R"(C:\Users\win 10\Documents\CLION\solution\minidataset.txt)");
        //string path(R"(C:\Users\win 10\Documents\CLION\solution\mediumdataset.txt)");
